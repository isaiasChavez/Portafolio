      ...
      <LayoutEmpty fade className="pb-32">
        ...
        <div className={`${styles.container}`}>
          <div className="mb-8 flex">
            ...
            <span className="ml-3 text-graycust">1 year 3 months</span>
          </div>
          ...
          <div className={`${styles.projectsContainer} pb-10`}>
            <Slide left>
              ...
              <ProjectRow
                ...
                subject={
                  <>
                    Proyecto para una empresa de salud, se quería presentar un
                    nuevo producto por lo cual se diseño una página a manera de
                    ...
                    enteramente estático y representó un reto para diseñar cada
              ...
              <ProjectRow
                ...
                subject={
                  <>
                    ...
                    cambiaron las escenas 3D y en este proyecto me tocó trabajar
                    por primera vez con las tecnologías 3D,{" "}
                    <a
                      className="text-secondary underline"
                      href="https://threejs.org/"
                    >
