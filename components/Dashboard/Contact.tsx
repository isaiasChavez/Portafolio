...
const Contact: React.FC<ContactProps> = () => {
  ...
  return (
    <div className=" bg-secondary text-shadow relative">
      <svg
        style={{
          zIndex: -1,
        }}
      ...
      <div className="   bg-darked-900 w-full">
        ...
        <div className="lg:h-64 flex justify-center items-center flex-wrap md:flex-nowrap py-10">
          ...
          <Card
            icono={faMailBulk}
            title="Email"
            subtitle={  <a href="mailto:isaiaschavez.co@gmail.com">
                isaiaschavez.co@gmail.com
              
              
              </a> }
          />
          <Card icono={faPhoneAlt} title="Phone" subtitle={<a href="tel:+529511212436">+52 9511212436</a>} />
          <div></div>
        </div>
      </div>
